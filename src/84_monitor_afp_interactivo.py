...
<div class="alerta">
  ...
  Es el valor anticipado por el modelo mientras se espera
  la publicación de la SBS.
</div>
...
<section class="seccion" id="graficos">
  ...
  <p class="ayuda">
    ...
    <strong>Línea discontinua:</strong> pronóstico congelado.
    Arrastra el mouse para ampliar una zona.
    Usa la rueda para acercar o alejar.
    Los botones «15 días», «1 mes», «3 meses»,
    «6 meses» y «Todo» cambian el periodo.
    La barra inferior permite desplazarte por la historia.
    Haz doble clic dentro del gráfico para volver a la vista completa.
  </p>
...
<section class="seccion">
  <h2>Pronósticos que todavía espera la SBS</h2>
