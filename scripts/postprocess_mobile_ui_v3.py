...
(function(){
  ...
  // Réplica del notebook: el cálculo usa operationSeries, no toda la SBS.
...
print("Visor móvil v3: operación idéntica al timeline del notebook + tallos a cero + hora intradía.")
